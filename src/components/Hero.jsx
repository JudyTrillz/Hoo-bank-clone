  ...
  return (
    <section
      ...
      <div
        ...
        <h1 className='font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full  sm:whitespace-nowrap'>
          Payment Method
        </h1>
      ...
      <div
        className={`flex-1 flex flex-col ${style.flexCenter} md:my-0 my-10 relative`}>
        <img
          src={robot}
          alt='Home Banner'
