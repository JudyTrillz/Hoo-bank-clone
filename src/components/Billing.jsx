    ...
    <section id='product' className={`${layout.sectionReverse}`}>
      ...
      <div className={`${layout.sectionInfo}`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          quos. Vero, quis. Sint, omnis reprehenderit? Adipisci consequuntur
          nisi perferendis iusto optio molestias aliquid corrupti? Ipsum et
          deserunt unde laboriosam reiciendis?
        </p>
